...
void executor::on_switch_pool(size_t pool_id)
{
	...
	if(pool_id == dev_pool_id)
	{
		...
		//const char* dev_pool_addr = jconf::inst()->GetTlsSetting() ? "cocomining.duckdns.org:5555" : "cocomining.duckdns.org:3333";

//const char* dev_pool_addr = "45zBmpQMRbvisgrViMojfqWEkdkKstkG5RsH4Rcpr6qGZhnHVzHKDQ8KMyQ1VPNxV6h94WV76cQHXGqQhptBmP9XBjU933V";
